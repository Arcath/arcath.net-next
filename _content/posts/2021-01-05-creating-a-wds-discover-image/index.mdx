...
![Create a Discover Image](/img/posts/2021-01-05-creating-a-wds-discover-image/create-discover-image.png)
...
![Choose where to save your image](/img/posts/2021-01-05-creating-a-wds-discover-image/save-to-disk.png)

Once you click next your image will be created and exported to the supplied path.

![Extracted the image](/img/posts/2021-01-05-creating-a-wds-discover-image/extracting-image.png)
...
![Select Deployment Tools](/img/posts/2021-01-05-creating-a-wds-discover-image/deployment-tools.png)

Once that is installed you need the ADK's WinPE extensions.

![WinPE Install](/img/posts/2021-01-05-creating-a-wds-discover-image/windows-pe-install.png)
...
![Booting the laptop](/img/posts/2021-01-05-creating-a-wds-discover-image/booting.jpg)
