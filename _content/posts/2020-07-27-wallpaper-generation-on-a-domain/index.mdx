...
![Unblock the file](/img/posts/2020-07-27-wallpaper-generation-on-a-domain/unblock.png)
...
![Excuse the default hostname](/img/posts/2020-07-27-wallpaper-generation-on-a-domain/lock.jpg)

A users wallpaper:

![Logged onto a server](/img/posts/2020-07-27-wallpaper-generation-on-a-domain/user.jpg)