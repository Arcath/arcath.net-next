...
![Adding ADCS](/img/posts/2016-07-22-radius-with-windows-server-2012r2/radius-adcs-1.png)
...
![Select Certification Authority](/img/posts/2016-07-22-radius-with-windows-server-2012r2/radius-adcs-2.png)
...
![Configure Active Directory Certificate Servers on the destination server](/img/posts/2016-07-22-radius-with-windows-server-2012r2/radius-adcs-3.png)
...
![Select services to configure](/img/posts/2016-07-22-radius-with-windows-server-2012r2/radius-adcs-4.png)
...
![Crypto Setup](/img/posts/2016-07-22-radius-with-windows-server-2012r2/radius-adcs-5.png)
...
![Confirmation Screen](/img/posts/2016-07-22-radius-with-windows-server-2012r2/radius-adcs-6.png)
...
![Select NPAS](/img/posts/2016-07-22-radius-with-windows-server-2012r2/radius-nps-1.png)
...
![NPS Role](/img/posts/2016-07-22-radius-with-windows-server-2012r2/radius-nps-2.png)
...
![Set the Key Name](/img/posts/2016-07-22-radius-with-windows-server-2012r2/radius-nps-3-a.png)
...
![NPS Screen](/img/posts/2016-07-22-radius-with-windows-server-2012r2/radius-nps-3.png)

Select _Secure Wireless Connections_ and click next (you can change the name if you want to).

![Create Network](/img/posts/2016-07-22-radius-with-windows-server-2012r2/radius-nps-4.png)

You need to add each access point to the list which can be pretty tedious.

![Adding Clients](/img/posts/2016-07-22-radius-with-windows-server-2012r2/radius-nps-5.png)

When adding an AP select the shared secret template we made earlier. Once you have added all your access points hit next.

![Add Client](/img/posts/2016-07-22-radius-with-windows-server-2012r2/radius-nps-6.png)

On the _Configure an Authentication Method_ screen select _Microsoft: Protected EAP (PEAP)_ and click _Configure_.

![Set the authentication method](/img/posts/2016-07-22-radius-with-windows-server-2012r2/radius-nps-7.png)

Change to the certificate for your DC, _dc.domain.local_ **NOT** _domain-dc-ca_.

![EAP Properties](/img/posts/2016-07-22-radius-with-windows-server-2012r2/radius-nps-8.png)
